...
nxyz_path1="datasets/BOP_DATASETS/lm/test/nxyz_crop-obj/000001/000000_000000-nxyz.pkl"

#z to out ,x to down,y to right

nxyz_info = mmcv.load(nxyz_path)
x1, y1, x2, y2 = nxyz_info["nxyxy"]
print(nxyz_info["nxyxy"])
...
ma=nxyz_crop[:,:,2]<0
imwrite("origon.png",nxyz_crop*255)
imwrite("two_type_normal_diff.png",-nxyz_crop[...,2]*ma*255)

nxyz_info1 = mmcv.load(nxyz_path1)
print(nxyz_info1["nxyxy"])
# float16 does not affect performance (classification/regresion)
nxyz_crop1 = nxyz_info["nxyz_crop"]
nxyz_crop1=nxyz_crop1[:,:,::-1]
imwrite("origon_ojb.png",nxyz_crop1*255)
