...
xyz_root = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/lm/train_pbr/nxyz_crop"))
        ...
        for scene_id in tqdm(sel_scene_ids, postfix=f"{split}_{scene}"):
            ...
            for str_im_id in tqdm(gt_dict, postfix=f"{scene_id}"):
                ...
                for anno_i, anno in enumerate(gt_dict[str_im_id]):
                    ...
                    bgr_gl, depth_gl,nomal_img = self.get_renderer().render(render_obj_id, IM_W, IM_H, K, R, t, near, far)
