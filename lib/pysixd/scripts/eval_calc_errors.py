...
p = {
    ...
    "out_errors_tpath": osp.join("{eval_path}", "{result_name}", "{error_sign}", "errors_{scene_id:06d}.json"),
}
################################################################################
                ...
                for est_id, est in obj_ests_sorted:
                    ...
                    for gt_id, gt in enumerate(scene_gt[im_id]):
                        ...
                        ################################
                            ...
                            if p["error_type"] in ["ABSad", "AUCad"]:
                                if obj_id in dp_model["symmetric_obj_ids"]:
                                    ...
                                    e = [pose_error.add(R_e, t_e, R_g, t_g, models[obj_id]["pts"]) / 10]  # mm to cm
                        ...
                        ################################
                            ...
                            proj_2d_err = pose_error.arp_2d(R_e, t_e, R_g, t_g, pts=models[obj_id]["pts"], K=K)
                            e = [proj_2d_err]
