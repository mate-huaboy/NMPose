...
class Renderer(object):#弄明白通道和缓冲区的设置

    MAX_FBO_WIDTH = 2000
    MAX_FBO_HEIGHT = 2000

    def __init__(self, models_cad_files, samples=1, vertex_tmp_store_folder=".", clamp=False, vertex_scale=0.001):
        ...
        # else:
        shader = gu.Shader("depth_shader_phong.vs", "depth_shader_phong.frag")   #shader 的获取？
