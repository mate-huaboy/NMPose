...
class LM_SYN_IMGN_Dataset(object):
    ...
    def __call__(self):  # LM_SYN_IMGN_Dataset
        ...
        for ann_file, scene_root, xyz_root ,nxyz_root in zip(self.ann_files, self.image_prefixes, self.xyz_prefixes,self.nxyz_prefixes):
            ...
            for im_id in tqdm(sel_indices):
                ...
                nxyz_path = osp.join(nxyz_root, f"{im_id}-nxyz.pkl")
...
SPLITS_LM_IMGN_13 = dict(
    lm_imgn_13_train_1k_per_obj=dict(
        ...
        nxyz_prefixes=[osp.join(DATASETS_ROOT, "lm_imgn/nxyz_crop_imgn/") for _obj in LM_13_OBJECTS],
