...
def trans_from_predictions_train(
    ...
    return translation,d  #增加返回中心信息

def trans_from_pred_centroid_z(
    pred_centroids,
    pred_z_vals,
    roi_cams,
    roi_centers,
    ...
    if is_train:
        return trans_from_predictions_train(
            pred_centroids,
            pred_z_vals,
            roi_cams,
            roi_centers,
        ...
        return trans_from_predictions_test(
            pred_centroids,
            pred_z_vals,
            roi_cams,
            roi_centers,
...
def trans_from_predictions_test(
    pred_centroids,
    pred_z_vals,
    roi_cams,
    roi_centers,
