...
# ---------------------------------------------------------------- #
# LINEMOD DATASET  by wenhua we can construct file structure by this
# ---------------------------------------------------------------- #
...
# scaled models (.obj) by wenhua----how to get the follow's data?
model_scaled_dir = osp.join(dataset_root, "models_scaled")
model_scaled_simple_dir = osp.join(dataset_root, "models_scaled_f5k")

train_synt_blender_dir = osp.join(dataset_root, "lm_blender/")#by wenhua how to get it
...
def get_fps_points():
    ...
    assert osp.exists(fps_points_path), fps_points_path   #false will assert  by wenhua
