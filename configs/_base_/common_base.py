...
SOLVER = dict(
    ...
    # OPTIMIZER_CFG=dict(type="RMSprop", lr=1e-4, momentum=0.0, weight_decay=0),#修改之前
    OPTIMIZER_CFG=dict(type="RMSprop", lr=3e-4, momentum=0.0, weight_decay=0),#修改之前
