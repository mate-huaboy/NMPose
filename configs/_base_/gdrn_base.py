...
MODEL = dict(
    ...
    CDPN=dict(
        ...
        ROT_HEAD=dict(
            ...
            # FREEZE=False,  #同时不训练
            # FREEZE=False,
            ROT_CONCAT=False,  #这里可能需要改,是否使用骨干网络的其他信息
